<template>
  <div class="editor-header">
    <div class="inner">
      <!-- Header -->
      <h1><router-link :to="{ name: 'MainPage' }">홈</router-link></h1>
      <div class="link-box">
        <button class="go-login" @click="loginOpen = true">로그인하기</button>
        <button class="go-logout" style="display:none">로그아웃하기</button>
